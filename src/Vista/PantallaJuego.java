		...
		if(o instanceof Tamagotchi) {
			...
			if(array[0]==4) {
				...
				if(array[1] == 0) {
					...
					BotónTama.setBackground(Color.YELLOW);
					BotónTama.setOpaque(true);
					
				}
				else if(array[1] == 1) {
					
					BotónTama.setBackground(Color.GREEN);
					
				}
				else if(array[1] == 2) {
					
					BotónTama.setBackground(Color.BLUE);
					...
					BotónTama.setBackground(Color.WHITE);
	...
	private class Controler implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			if (e.getSource().equals(BotónCandy)){
					...
					Comida c=new Candy();
					ListaAlimentos.getListaAlimentos().añadirComida(new Candy());
