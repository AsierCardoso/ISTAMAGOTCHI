...
public class PantallaInicio extends JFrame {
    ...
    //////////////////////////     EL MAIN AL QUE ACCEDE EL EJECUTABLE 
	...
	private JLabel getTitulo() {
		if (Titulo == null) {
			Titulo = new JLabel("");
			ImageIcon icon = new ImageIcon("C:/Users/34608/Desktop/wsjava/IS_Tamagochi/src/imagenes/MainTitle.png");
			Titulo.setIcon(icon);
		}
		return Titulo;
	}
	private JLabel getTuNombre() {
		if (TuNombre == null) {
			...
			TuNombre.setForeground(new Color(255, 255, 255));
		}
		return TuNombre;
	}
